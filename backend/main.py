...
Customer support platform with ticketing, live chat, and knowledge base
"""
...
app = FastAPI(
    title="SupportDesk",
    description="Customer support platform with ticketing, live chat, and knowledge base",
    version="1.0.0",
)
